...
from gui.menu import counting as desc
...
class Counting(ttk.Frame):
    ...
    def __init__(self, parent, controller=None):
        ...
        # Etichette iniziali
        ttk.Label(self, text="Counting Sort", font=("Arial", 24)).pack(pady=20)
...
class Marge(ttk.Frame):
    def __init__(self, parent, controller=None):
        super().__init__(parent)

        # Etichette iniziali
        ttk.Label(self, text="Algortmo di ordinamento: Marge", font=("Arial", 24)).pack(pady=20)
...
class Bubble(ttk.Frame):
    def __init__(self, parent, controller=None):
        ...
        # Etichette iniziali
        ttk.Label(self, text="Algortmo di ordinamento: Bubble", font=("Arial", 24)).pack(pady=20)

class Insertion(ttk.Frame):
    def __init__(self, parent, controller=None):
        super().__init__(parent)

        # Etichette iniziali
        ttk.Label(self, text="Algortmo di ordinamento: Insertion", font=("Arial", 24)).pack(pady=20)

class Quik(ttk.Frame):
    def __init__(self, parent, controller=None):
        super().__init__(parent)

        # Etichette iniziali
        ttk.Label(self, text="Algortmo di ordinamento: Quik", font=("Arial", 24)).pack(pady=20)
